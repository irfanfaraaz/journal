  ...
  InstructionWithAccounts<
    [
      TAccountJournal extends string
        ? WritableAccount<TAccountJournal>
        : TAccountJournal,
      ...TRemainingAccounts,
    ]
  >;
...
export type IncrementInput<TAccountJournal extends string = string> = {
...
>(
  input: IncrementInput<TAccountJournal>,
  config?: { programAddress?: TProgramAddress }
): IncrementInstruction<TProgramAddress, TAccountJournal> {
  // Program address.
  ...
  const instruction = {
    accounts: [getAccountMeta(accounts.journal)],
    programAddress,
    data: getIncrementInstructionDataEncoder().encode({}),
  } as IncrementInstruction<TProgramAddress, TAccountJournal>;
