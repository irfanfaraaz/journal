...
export type DecrementInput<TAccountJournal extends string = string> = {
...
>(
  input: DecrementInput<TAccountJournal>,
  config?: { programAddress?: TProgramAddress }
): DecrementInstruction<TProgramAddress, TAccountJournal> {
  // Program address.
  ...
  } as DecrementInstruction<TProgramAddress, TAccountJournal>;
